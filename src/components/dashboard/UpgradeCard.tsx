  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-500 to-brand-700 p-6 text-white shadow-lift">
      ...
      <div className="relative">
        ...
        <Link to="/pricing" className="mt-4 inline-flex items-center gap-1.5 rounded-xl bg-white px-4 py-2 text-sm font-semibold text-brand-700 transition-transform hover:-translate-y-0.5">
          See plans
