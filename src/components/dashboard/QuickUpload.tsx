  ...
  return (
    <Card className="flex flex-col p-6">
      ...
      <div className="mt-4 flex-1">
        {/* Quick upload always targets the root folder — for uploading into
            a specific folder, use the dropzone on the Files page instead. */}
        <UploadDropzone compact onItemsSelected={(items) => enqueue(items, undefined)} />
      </div>
    </Card>
  )
}
